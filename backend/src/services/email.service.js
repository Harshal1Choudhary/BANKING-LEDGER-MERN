...
async function sendRegistrationEmail(userEmail, name) {
  ...
  const html = `<p>Hello ${name},</p><p>Thank you for registering at Banking Ledger. We're excited to have you on board!</p><p>Best regards,<br>The Banking Ledger Team</p>`;
